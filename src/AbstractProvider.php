...
use Puviz\LinkedInConnect\Contracts\Provider as ProviderContract;
...
abstract class AbstractProvider implements ProviderContract
{
     ...
     *
     * @param array $user
     * @return \Puviz\LinkedInConnect\User
     */
     ...
     * @return string
     */
    protected function formatScopes(array $scopes, string $scopeSeparator)
    {
